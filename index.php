								...
								<div class="card-body">
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="btn-group">
											...
											<span class="btn btn-outline-secondary" onclick="copyToClipboard('https://toolpic.youthforclimate.fr/carto/viewmap.php?id=<?php echo $map["id"] ?>')">Copier le lien</span>
