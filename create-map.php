	...
	<body>
		...
		<main role="main">
			<div class="container">
  				<div class="jumbotron mt-3">
    				...
    				<p class="lead">Votre carte a bien été créée !</p>
		...
		<main role="main">
			<div class="container">
  				<div class="jumbotron mt-3">
    				<h1>Créer une carte</h1>
    				<p class="lead">Pour réinitialiser une carte, vous pouvez en recréer une avec le même identifiant! Cela réinitilisera ses données.</p>
  				</div>
				
				<form method="post" class="form-horizontal">
					<div class="form-group">
						<label for="id">Identifiant de la carte</label>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="name" id="name" required data-length="50" aria-describedby="nameHelp" placeholder="Ma carte..."/>
						<small id="nameHelp" class="form-text text-muted">Le nom d'affichage (public) de la carte.</small>
					</div>

					<div class="form-group">
						<label for="description">Description de la carte</label>
						<input class="form-control" type="text" name="description" id="description" required data-length="50" aria-describedby="descriptionHelp" />
						<small id="descriptionHelp" class="form-text text-muted">Optionnel. Objectif de la carte, prénoms des responsables...</small>
					</div>

					<div class="form-group form-check">
						<input type="checkbox" class="form-check-input" id="pubEdit" name="pubEdit" checked>
					...
					<button type="submit" class="btn btn-primary" name="action">Enregistrer</button>
				</form>
			</div>
		</main>
		<?php } ?>
